...
public class Ex4_TicTacToeGame {
    ...
    private static String[] remainingCellsArray = {"A1", "A2", "A3", "B1", "B2", "B3", "C1", "C2", "C3"};
    ...
    private static void multipleGames() {
        ...
        /*System.out.println("First player name: ");
        String firstPlayerName = scanner.nextLine().trim();
        System.out.println("Second player name(if you want to play with the computer enter 'CPU'): ");
        String secondPlayerName = scanner.nextLine().trim();*/
    ...
    private static void markOUX(char[][] board, String secondPlayerName) {
    ...
    private static String defensiveCPU(char[][] board) {
        Random rand = new Random();
        String cell = "";
