...
public class PersonsRegistryTest {
    ...
    public void testRegisterAndCount() {
        PersonsRegistry r = (PersonsRegistry) new PersonsRegistryImpl();
    ...
    public void test_averageAge_empty() {
        assertEquals(0, ((PersonsRegistry) new PersonsRegistryImpl()).averageAge(), DELTA);
    }
    ...
    public void adultsPercentage_empty() {
        assertEquals(0, ((PersonsRegistry) new PersonsRegistryImpl()).adultsPercentage(), DELTA);
    }
    ...
    public void adultsWhoVotedPercentage_empty() {
        assertEquals(0, ((PersonsRegistry) new PersonsRegistryImpl()).adultsWhoVotedPercentage(), DELTA);
    }

    private PersonsRegistry sampleRegistry() {
        PersonsRegistry reg = (PersonsRegistry) new PersonsRegistryImpl();
